...
> [!WARNING]
> **Nulltrap в ранней разработке и пока не запускает Roblox.**
> Готова Фаза 0: решение собирается, архитектурное правило под защитой, CI
> работает. Остальное — в процессе. См. [Статус](#статус).
...
| 1 | Развёртывание, загрузка пакетов, обработчики протоколов, запуск | В работе |
| 2 | Моды, FastFlags, отслеживание сессии, Discord RPC | Запланировано |
